...
def test_middle_school_ind_score_generator_normalization_by_participant() -> None:
    ...
    generator = MiddleSchoolIndividualScoreGenerator(all_results=[0, 1, 2, 3, 4, 5, 6, 7], theoretical_maximum=10)
    assert generator.compute() == (0, 14, 29, 43, 57, 71, 86, 100)
    generator = MiddleSchoolIndividualScoreGenerator(all_results=[5], theoretical_maximum=10)

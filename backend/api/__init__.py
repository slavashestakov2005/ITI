...
from . import group_result, message, result, student, student_class, subject, subject_student, team, team_student,\
    user, year, year_subject
...
api.add_resource(student_class.StudentClassResource, '/api/v1/student_class/<year:year>/<int:student_id>')
...
api.add_resource(year_subject.YearSubjectResource, '/api/v1/year_subject/<year:year>/<int:subject>')

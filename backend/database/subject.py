...
class SubjectsTable(Table):
    ...
    def create_table() -> None:
        ...
        SubjectsTable.insert(Subject([None, 'Конструкторская задача', 'Констр.', 'g', 'в конструкторской задаче', 'конструкторской задачи']))
        ...
        SubjectsTable.insert(Subject([None, 'Искусство 5-6', 'Иск.', 'i', 'в индивидуальном туре\nпо искусству', 'по искусству среди 5-6 классов']))
        SubjectsTable.insert(Subject([None, 'Искусство 7-9', 'Иск.', 'i', 'в индивидуальном туре\nпо искусству', 'по искусству среди 7-9 классов']))
        SubjectsTable.insert(Subject([None, 'Настольные игры', 'Наст.', 'g', 'в настольных играх', 'настольных игр']))
        SubjectsTable.insert(Subject([None, 'Бонус', 'Бонус', 'g', 'бонусном туре', 'выставления бонусных баллов за публичную защиту']))
        SubjectsTable.insert(Subject([None, '«Зри в корень»', '«Зри...»', 'g', 'в групповом туре\n«Зри в корень»', 'игры «Зри в корень»']))
